...
\begin{frame}{Analiza}
	\begin{enumerate}
		\item
		Pokaži, da je funkcija $x\mapsto\sqrt{x}$ enakomerno zvezna na $[0,2\pi)$.
		\item 
...
\begin{frame}{Kompleksna števila}
	\begin{enumerate}
		...
		\item
		Poenostavi izraz:
		$$\displaystyle\frac{\displaystyle\frac{3+1}{2-2i}+\frac{7i}{1-i}}{\displaystyle1+\frac{i-1}{4}-\frac{5}{2-3i}}$$
	\end{enumerate}
\end{frame}