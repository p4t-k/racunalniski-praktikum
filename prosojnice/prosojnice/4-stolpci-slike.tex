\begin{frame}{Konstrukcija pravokotnice na premico $p$ skozi točko $T$}
	\begin{columns}
		...
		\begin{itemize}
			 \item \onslide<1-7>Dani sta premica $p$ in točka $T$.
			 \item \onslide<2-7>Nariši lok $k$ s središčem v $T$.
			 \item \onslide<3-7>Premico $p$ seče v točkah $A$ in $B$.
			 \item \onslide<4-7>Nariši lok $m$ s središčem v $A$.
			 \item \onslide<5-7>Nariši lok $n$ s središčem v $B$ in z enakim polmerom.
			 \item \onslide<6-7>Loka se sečeta v točki $C$.
			 \item \onslide<7>Premica skozi točki $T$ in $C$ je pravokotna na $p$.
		\end{itemize}
		\column{0.45\textwidth}
		\centering
		%\onslide<1>\includegraphics[width=50mm]{slike/fig-1.png}%
		%   \onslide<2>\includegraphics[width=50mm]{slike/fig-2.png}%
		%   \onslide<3>\includegraphics[width=50mm]{slike/fig-3.png}%
		%   \onslide<4>\includegraphics[width=50mm]{slike/fig-4.png}%
		%   \onslide<5>\includegraphics[width=50mm]{slike/fig-5.png}%
		%   \onslide<6>\includegraphics[width=50mm]{slike/fig-6.png}%
		%\onslide<7>\includegraphics[width=50mm]{slike/fig-7.png}
	\end{columns}
\end{frame}
...
\begin{frame}{Konstrukcija pravokotnice na premico $p$ skozi točko $T$}
	\begin{columns}
		...
		% Sliko smo naredili tako, da so točke A, B, T in C vse enako oddaljene od presečišča premic; kot ATC je 45°.
		...
		\begin{tikzpicture}
			...
			% Definicija točke T
			\onslide<1-7>\coordinate [label={[blue, above left]:$T$}] (T) at (0,{\t});
			% Risanje točke T
			\onslide<1-7>\fill[blue] (T) circle (2pt);
			% Premica p
