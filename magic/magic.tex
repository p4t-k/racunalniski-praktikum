...
\usepackage{lmodern}
\usepackage{amsmath, amsthm, environ}
...
\newenvironment{dokaz}{\emph{Dokaz izreka}.}{\qed\\}
...
\begin{table}
   ...
   \begin{tabular}{lcccccc}\toprule
         ...
         red & 1 & 2 & 3 & 4 & 5 & 6 \\
         število kvadratov & 1 & 0 & 1 & 880 & 275305224 & 1  \\ \bottomrule
   \end{tabular}
   \label{table:stevila}
\end{table}
